...
animais = ["gato", "cao", "tartaruga", "peixe", "tigre","pombo"]
...
while opcao != "3":
    ...
    if opcao == "1":
        ...
        if animal_secreto == "gato":
            dica = "Dica: Mia e não gosta de água."
        ...
        elif animal_secreto == "tigre":
            dica = "Dica: É grande e é laranja e preto."
        elif animal_secreto == "pombo":
            dica = "Dica: Ratazana do ar"
        print(dica)

        while tentativas > 0:
            chute = input("Qual é o animal? ")
